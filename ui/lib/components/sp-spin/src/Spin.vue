<template>
  <div class="sp-spin" :class="wrapperClasses">
    <div v-if="loading && isDelayOver" class="sp-spin__loading" :class="spinClasses">
      <slot name="dot">
        <span class="sp-spin__dot">
        <i class="sp-spin__dot-item"></i>
        <i class="sp-spin__dot-item"></i>
        <i class="sp-spin__dot-item"></i>
        <i class="sp-spin__dot-item"></i>
      </span>
      ...
      <div class="sp-spin__text">
        <slot name="text">{{tip}}</slot>
      </div>
    </div>
    <div v-if="$slots.default" class="sp-spin__container" :class="containerClasses">
      <slot></slot>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      wrapperClasses() {
        return {
          'sp-spin--nested': !!this.$slots.default,
          'is-fit': this.fit
        }
      },
      containerClasses() {
