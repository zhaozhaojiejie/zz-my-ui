<template>
  <transition-group tag="div" :class="classes" :name="name">
    <div v-if="isInit" class="sp-lazy__component" key="component">
      <slot></slot>
    </div>
    <div v-else key="skeleton" class="sp-lazy__skeleton">
...
<script>
  ...
  export default {
     ...
     * 属性参数
     * @member props
     * @property {string} [name=sp-lazy] transition名称，用来定制动画
