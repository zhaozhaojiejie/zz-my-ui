<template>
  <Card class="sp-panel" :shadow="shadow" :class="classes" :bodyStyle="cardBodyStyle">
    <template v-if="header" v-slot:header>
      <div v-if="tabs" class="sp-panel__header sp-panel__tabs" ref="header" :style="headerStyle">
        ...
        <div v-if="$slots.handle" class="sp-panel__handle">
          <slot name="handle"></slot>
        </div>
      </div>
      <div v-else class="sp-panel__header" ref="header" :style="headerStyle">
        <slot name="header">
          <sp-header :title="title"
                     :icon="icon"
                     :theme="titleTheme"
                     :size="size"
    ...
    <div v-if="$slots.footer"
         ref="footer"
         class="sp-panel__footer"
         :class="[`is-${footerAlign}`, `is-${theme}`]"
         :style="footerStyle">
      <slot name="footer"></slot>
    </div>
    <div v-if="actions && actions.length" class="sp-panel__actions">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      classes() {
        return {
          [`sp-panel--${this.theme}`]: !!this.theme,
          'is-fit': this.fit,
