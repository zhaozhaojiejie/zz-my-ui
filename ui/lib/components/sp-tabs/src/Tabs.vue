<template>
  <spContainer class="sp-tabs" :class="classes" :fit="isFit" v-bind="$attrs">
    <Tabs v-if="tabs"
          :type="cardType"
          class="sp-tabs__tabs"
          v-model="tabName"
...
<script>
  /**
   * 选项卡容器组件
   * @module $ui/components/sp-tabs
   */
  import {spContainer} from '$ui'
  ...
  export default {
    ...
    /**
     * 属性参数， 继承 spContainer 的全部参数，如 fit、shadow、border
     * @member props
