<template>
  <transition name="sp-radial-menu">
    <div v-if="visible && flashHelper"
         v-clickoutside="handleClickOutside"
         class="sp-radial-menu"
         :style="styles">
      <svg class="sp-radial-menu__icons">
      ...
      <svg class="sp-radial-menu__menu" viewBox="-50 -50 100 100" :width="size" :height="size">
        ...
        <g class="sp-radial-menu__center" @click="handleCenterClick">
...
<script>
  /**
   * 圆形菜单组件
   * @module $ui/components/sp-radial-menu
   */
    ...
    methods: {
      ...
      outerEffect() {
        ...
        this.timerId = setTimeout(() => {
          setClassAndWaitForTransition(this.cloneEl, 'sp-radial-menu-outer').then(this.clean)
        }, 20)
      },
