 ...
 * 基础文本组件
 */
import {spClipboard, spIcon} from '$ui'
...
export default {
  ...
  methods: {
    ...
    renderCopy() {
      ...
      return (
        <sp-clipboard class="sp-typography__copy"
                      tooltip
                      text={this.getCopyText}
                      onSuccess={this.handleCopy}>
          <sp-icon name={this.copyIcon}
                   class={{'sp-typography__copy-icon': true, 'is-copied': this.copied}}></sp-icon>
        </sp-clipboard>
      )
    },
    renderEdit() {
      ...
      return (
        <Tooltip class="sp-typography__edit"
                 content="编辑"
                 placement="top">
        <span>
          <sp-icon class="sp-typography__edit-icon"
                   name="el-icon-edit"
                   onClick={this.handleEdit}></sp-icon>
        </span>
        </Tooltip>
      )
    },
    renderExpand() {
      ...
      return (<a class="sp-typography__expand" onClick={this.toggleExpand}>{this.expanded ? '收起' : '展开'}</a>)
    },
    renderEditInput() {
      return (
