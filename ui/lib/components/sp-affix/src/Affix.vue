<template>
  <div class="sp-affix__placeholder" :style="placeholderStyle" ref="placeholderNode">
    <div :class="{'sp-affix':!!affixStyle}" ref="fixedNode" :style="affixStyle">
      <slot></slot>
    </div>
  </div>
</template>
