<template>
  <BasePicker class="sp-tree-select"
              :disabled="readonly || disabled"
              ref="picker"
              popper-class="sp-tree-select__popover"
              ref-class="sp-tree-select__ref">
    ...
    <div class="sp-tree-select__content">
      <ElInput v-if="filter"
               class="sp-tree-select__filter"
               v-model="query"
               size="small"
               clearable
               placeholder="请输入筛选关键字"></ElInput>
      <Tree class="sp-tree-select__tree is-line"
            ref="tree"
            v-bind="tree"
...
<script>
  /**
   * 下拉树组件
   * @module $ui/components/sp-form/src/common/TreeSelect
   */
