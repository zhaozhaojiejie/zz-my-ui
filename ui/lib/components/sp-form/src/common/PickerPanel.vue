<template>
  <spLayout class="sp-picker-panel"
    ...
    <template v-if="groupList" v-slot:west>
      <div class="sp-picker-panel__sidebar" :style="sidebarStyle">
        <ul class="sp-picker-panel__groups">
    ...
    <div :style="mainStyle">
      <slot>
        <spList class="sp-picker-panel__list"
                ref="list"
                :class="listClass"
                v-bind="listProps"
                mode="virtual"
...
<script>
  import {spLayout, spList} from '$ui'
