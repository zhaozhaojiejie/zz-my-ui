...
export default {
  ...
  methods: {
    ...
    createSeparator() {
      return <span class="sp-range__separator">{this.separator}</span>
    },
    renderNumber() {
      return [
        <InputNumber class="sp-range__input" {...{props: this.innerProps, attrs: this.innerProps}}
    ...
    renderDate() {
      return [
        <DatePicker class="sp-range__input" {...{props: this.innerProps, attrs: this.innerProps}}
    ...
    renderTime() {
      return [
        <TimeSelect class="sp-range__input" {...{props: this.innerProps, attrs: this.innerProps}}
