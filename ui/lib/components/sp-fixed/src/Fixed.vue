<template>
  <div :class="classes" :style="styles">
    <div v-if="$slots.header" ref="header" class="sp-fixed__header" :style="translate">
      <slot name="header"></slot>
    </div>
    <slot></slot>
    <div v-if="$slots.footer" ref="footer" class="sp-fixed__footer" :style="translate">
