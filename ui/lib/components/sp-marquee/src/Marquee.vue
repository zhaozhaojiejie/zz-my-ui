<template>
  <div class="sp-marquee"
    ...
    <div class="sp-marquee__scroll" :style="scrollStyle">
      <div ref="content" class="sp-marquee__content">
        <slot></slot>
      </div>
      <div class="sp-marquee__copy-content" v-html="copyHtml"></div>
    </div>
  </div>
</template>
...
<script>
  /**
   * 无缝滚动
   * @module $ui/components/sp-marquee
   */
  ...
  export default {
    ...
    computed: {
      ...
      classes() {
        return {
          'sp-marquee--horizontal': this.isHorizontal
        }
      },
      scrollStyle() {
        return {
